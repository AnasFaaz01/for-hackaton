...
import { HiClock, HiEye, HiHandRaised, HiTrash, HiSpeakerWave, HiFunnel } from "react-icons/hi2";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-20 bg-slate-800/20 rounded-3xl border-2 border-dashed border-slate-700/50">
            ...
            <p className="text-slate-400 font-medium">No gestures logged yet</p>
            <p className="text-slate-600 text-sm mt-1">
              {filter !== "all" ? `No ${filter} gestures found.` : "Use Hand Mode or Eye Mode to start."}
            </p>
          </div>
        ) : (
