...
import { Bell, Clock, Eye, Hand, Trash2, Volume2, CheckCircle, Filter, Activity, AlertCircle, BarChart3 } from "lucide-react";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-600 mt-0.5">{formatTime(entry.timestamp)} &middot; {Math.round(entry.confidence * 100)}% confidence</div>
                    </div>
