...
const GESTURE_GUIDE = [
  ...
  { label: "PAUSE", desc: "Open palm wide held 5s to toggle pause/resume", emoji: "🖐️", cls: "text-amber-400 border-amber-700/30 bg-amber-900/20" },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-900/50 text-blue-300 text-sm font-medium mb-4 border border-blue-700/30">
          ...
          <p className="mt-3 text-slate-400 text-lg max-w-2xl mx-auto">
            Raise your hand and make a gesture. Show open palm wide 🖐️ and hold 5s to toggle pause/resume.
          </p>
        </motion.div>
        ...
        <AnimatePresence>
          {isPaused && cameraOn && (
            ...
            >
              ...
              System PAUSED — Show open palm wide (🖐️) to resume
            </motion.div>
          )}
        </AnimatePresence>
              ...
              {!cameraOn && !loading && (
                <div className="absolute inset-0 flex items-center justify-center bg-slate-900/95 z-10">
                  <div className="text-center max-w-xs">
                    <div className="w-24 h-24 rounded-full bg-blue-500/10 border-2 border-dashed border-blue-400/30 flex items-center justify-center mx-auto mb-6">
                      <HiVideoCamera className="w-10 h-10 text-blue-400/60" />
                    </div>
                    <button
                      onClick={startCamera}
                      className="px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold text-lg shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 active:scale-95 transition-all duration-300"
                    >
                      Start Camera
                    </button>
            ...
            <AnimatePresence mode="wait">
              {isPaused ? (
                ...
                >
                  ...
                  <div className="text-xs text-amber-400/50">Show open palm wide 🖐️ to resume</div>
                </motion.div>
                ...
                >
                  <div className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-violet-400 mb-1">
                    {gesture}
                  </div>
                  ...
                  <div className="w-full bg-slate-700/50 rounded-full h-3 overflow-hidden shadow-inner">
                    <motion.div
                      ...
                      className="h-full bg-gradient-to-r from-blue-500 via-blue-600 to-violet-500 rounded-full"
                    />
                  </div>
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-slate-800/50 flex items-center justify-center mx-auto mb-4">
                    <HiHandRaised className="w-8 h-8 text-slate-600" />
                  </div>
