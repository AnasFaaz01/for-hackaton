      ...
      <body className="min-h-screen bg-slate-50 text-slate-700 antialiased">
        ...
        <footer className="border-t border-slate-200 bg-white">
          <div className="max-w-6xl mx-auto px-6 lg:px-8 py-14">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
              <div className="md:col-span-2">
                <div className="flex items-center gap-2.5 mb-4">
                  ...
                  <div>
                    <span className="font-bold text-base text-slate-900">CareSpeak</span>
                    <span className="text-teal-600 font-bold text-base"> AI</span>
                  </div>
                </div>
            ...
            <div className="mt-10 pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
